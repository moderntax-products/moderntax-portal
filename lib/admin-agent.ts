...
function buildSystemPrompt(): string {
  return [
    ...
    '  PAYOUTS: experts find their pay schedule, current earnings, payout history, and W-9 (download blank +',
    '  upload signed) in the portal under Payouts (/expert/payouts, linked from the Expert Queue). They are',
    '  paid bi-weekly at their hourly rate, about two weeks after each period closes; a signed W-9 must be on',
    '  file to be paid / issued a 1099. If asked "where is the dashboard / W-9 / pay schedule," point them to',
    '  /expert/payouts. Do not quote a specific dollar amount unless it is in the provided context.',
