    ...
    Tables: {
      clients: {
        Row: {
          ...
          bypass_payment_paywall: boolean;
          monitoring_default_enabled: boolean | null;
          cash_flow_auto_attach: boolean | null;
          trial_entities_allowed: number;
      ...
      invoices: {
        Row: {
          ...
          mercury_invoice_slug: string | null;
          mercury_pay_url: string | null;
          mercury_pdf_url: string | null;
          monitoring_entities: number | null;
          monitoring_amount: number | null;
