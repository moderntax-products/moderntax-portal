...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    cta: { label: 'Try CSV upload →', href: '/new/csv' },
  },
  {
    id: 'pdf-upload',
    role: 'all',
    ...
    cta: { label: 'Try PDF upload →', href: '/new/pdf' },
  },
  {
    id: 'manual-entry',
    role: 'all',
    ...
    cta: { label: 'Try manual entry →', href: '/new/manual' },
  },
  {
  ...
  },
  {
    ...
    cta: { label: 'See sample request →', href: '/sample-request' },
  },
  {
    id: 'compliance',
    role: 'all',
