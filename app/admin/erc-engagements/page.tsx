    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mt-1 mb-6">
          <h1 className="text-2xl font-bold text-gray-900">ERC Recovery Engagements</h1>
          <Link
            href="/admin/erc-engagements/new"
            className="px-4 py-2 text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 rounded"
          >
            + New Engagement
          </Link>
        </div>
